...
import com.opengamma.strata.function.calculation.etd.GenericFutureOptionCalculationFunction;
import com.opengamma.strata.function.calculation.etd.GenericFutureOptionFunctionGroups;
import com.opengamma.strata.function.calculation.etd.GenericFutureOptionMeasureCalculations;
...
/**
 * Test {@link GenericFutureOptionCalculationFunction}.
 */
@Test
public class GenericFutureOptionCalculationFunctionTest {
  ...
  private static final StandardId SEC_ID = StandardId.of("OG-FutureOption", "Foo-Womble-Mar14");
  private static final GenericFutureOption OPTION = GenericFutureOption.builder()
      ...
      .build();
  public static final GenericFutureOptionTrade TRADE = GenericFutureOptionTrade.builder()
      .securityLink(SecurityLink.resolved(
          UnitSecurity.builder(OPTION)
              .standardId(SEC_ID)
              .build()))
  ...
  public void test_group() {
    FunctionGroup<GenericFutureOptionTrade> test = GenericFutureOptionFunctionGroups.market();
    assertThat(test.configuredMeasures(TRADE)).contains(
        Measures.PRESENT_VALUE);
    FunctionConfig<GenericFutureOptionTrade> config =
        GenericFutureOptionFunctionGroups.market().functionConfig(TRADE, Measures.PRESENT_VALUE).get();
    assertThat(config.createFunction()).isInstanceOf(GenericFutureOptionCalculationFunction.class);
  }
  ...
  public void coverage() {
    coverPrivateConstructor(GenericFutureOptionFunctionGroups.class);
    coverPrivateConstructor(GenericFutureOptionMeasureCalculations.class);
  }
