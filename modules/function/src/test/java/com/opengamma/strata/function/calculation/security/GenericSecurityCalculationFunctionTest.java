...
import com.opengamma.strata.function.calculation.security.GenericSecurityCalculationFunction;
import com.opengamma.strata.function.calculation.security.GenericSecurityFunctionGroups;
import com.opengamma.strata.function.calculation.security.GenericSecurityMeasureCalculations;
...
public class GenericSecurityCalculationFunctionTest {
  ...
  private static final GenericSecurity FUTURE = GenericSecurity.of(SEC_ID, TICK_SIZE, CurrencyAmount.of(EUR, TICK_VALUE));
