 ...
 */
public final class GenericSecurityFunctionGroups {
  ...
  private static final FunctionGroup<GenericSecurityTrade> MARKET_GROUP =
      DefaultFunctionGroup.builder(GenericSecurityTrade.class).name("GenericSecurityTradeMarket")
          .addFunction(Measures.PRESENT_VALUE, GenericSecurityCalculationFunction.class)
          .build();

  /**
   * Restricted constructor.
   */
  private GenericSecurityFunctionGroups() {
  }
