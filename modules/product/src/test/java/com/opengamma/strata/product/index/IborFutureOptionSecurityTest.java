...
public class IborFutureOptionSecurityTest {
  ...
  private static final SecurityInfo INFO = SecurityInfo.of(OPTION.getSecurityId());
  private static final SecurityInfo INFO2 = SecurityInfo.of(OPTION2.getSecurityId());
