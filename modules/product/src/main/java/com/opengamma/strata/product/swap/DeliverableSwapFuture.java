...
public final class DeliverableSwapFuture
    implements SecurityProduct, Resolvable<ResolvedDeliverableSwapFuture>, ImmutableBean, Serializable {
  ...
  //-------------------------------------------------------------------------
  @Override
  public ResolvedDeliverableSwapFuture resolve(ReferenceData refData) {
    ResolvedSwap resolvedSwap = underlyingSwap.resolve(refData);
    return new ResolvedDeliverableSwapFuture(securityId, notional, deliveryDate, lastTradeDate, resolvedSwap);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<SecurityId> securityId = DirectMetaProperty.ofImmutable(
        this, "securityId", DeliverableSwapFuture.class, SecurityId.class);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 1574023291:  // securityId
          return ((DeliverableSwapFuture) bean).getSecurityId();
        case 1585636160:  // notional
