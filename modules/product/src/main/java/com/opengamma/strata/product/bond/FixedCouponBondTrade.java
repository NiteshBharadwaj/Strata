...
public final class FixedCouponBondTrade
    implements SecurityProductTrade, ResolvableTrade<ResolvedFixedCouponBondTrade>, ImmutableBean, Serializable {
  ...
  public ResolvedFixedCouponBondTrade resolve(ReferenceData refData) {
    ...
    return new ResolvedFixedCouponBondTrade(tradeInfo, resolved, quantity, price, payment);
  }
