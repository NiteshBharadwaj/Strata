...
public final class DeliverableSwapFutureTrade
    implements SecurityProductTrade, ResolvableTrade<ResolvedDeliverableSwapFutureTrade>, ImmutableBean, Serializable {
  ...
  //-------------------------------------------------------------------------
  @Override
  public ResolvedDeliverableSwapFutureTrade resolve(ReferenceData refData) {
    ResolvedDeliverableSwapFuture resolved = getProduct().resolve(refData);
    return new ResolvedDeliverableSwapFutureTrade(tradeInfo, resolved, quantity, price);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<DeliverableSwapFuture> product = DirectMetaProperty.ofImmutable(
        this, "product", DeliverableSwapFutureTrade.class, DeliverableSwapFuture.class);
    /**
    ...
    private final MetaProperty<Double> price = DirectMetaProperty.ofImmutable(
        this, "price", DeliverableSwapFutureTrade.class, Double.TYPE);
    /**
     * The meta-properties.
     */
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -309474065:  // product
          return ((DeliverableSwapFutureTrade) bean).getProduct();
        case -1285004149:  // quantity
          return ((DeliverableSwapFutureTrade) bean).getQuantity();
        case 106934601:  // price
          return ((DeliverableSwapFutureTrade) bean).getPrice();
      }
