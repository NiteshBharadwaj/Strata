...
public final class FixedCouponBondSecurity
  ...
  public FixedCouponBondTrade createTrade(TradeInfo tradeInfo, long quantity, double tradePrice, ReferenceData refData) {
    ...
    return new FixedCouponBondTrade(tradeInfo, product, quantity, tradePrice, null);
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -309474065:  // product
          return ((FixedCouponBondSecurity) bean).getProduct();
        case 3237038:  // info
          return ((FixedCouponBondSecurity) bean).getInfo();
        case 1574023291:  // securityId
          return ((FixedCouponBondSecurity) bean).getSecurityId();
        case 575402001:  // currency
