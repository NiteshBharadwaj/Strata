...
public final class SecurityId
    implements ReferenceDataId<Security>, Resolvable<Security>, Serializable {
   ...
   * <p>
   * This returns an instance of {@link Security}.
   * <p>
   ...
   */
  @Override
  public Security resolve(ReferenceData refData) {
   ...
   * <p>
   * This returns an instance of {@link Security} cast to the specified type.
   * <p>
   * Resolved objects may be bound to data that changes over time.
   * If the data changes, the resolved form will not be updated.
   * Care must be taken when placing the resolved form in a cache or persistence layer.
   ...
   */
  public <T extends Security> T resolve(ReferenceData refData, Class<T> securityType) {
